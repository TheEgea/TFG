## Annexos (Technical Reference)

<iframe src="/TFG/assets/official_Documents/annexos-main.pdf#view=FitH&scrollbar=0" 
        width="100%" 
        height="800px" 
        style="border:1px solid #ddd; border-radius:8px;">
  PDF no visible? <a href="./annexos-main.pdf">Download Annexos</a>
</iframe>

**Controls:** Zoom, scroll, fullscreen (browser PDF viewer)

[Download PDF](./annexos-main.pdf)
