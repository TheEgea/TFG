...
**Deliverables**: Formal project proposal (Preliminary Project); detailed Gantt chart with
...
Student lab guide PDF (student lab guide) per lab: task description, objectives, hints,
and tool reference. Instructor resolution guide PDF (instructor solution guide) per lab:
