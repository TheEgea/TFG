% LaTeX template for writing a Final Degree Project (TFG)
...
% Template for Final Degree Projects at Centre Universitari TecnoCampus. Based on the original template by Aitor Juanola.
...
\usepackage{fontspec}           % Manage OpenType/TrueType fonts


% Do NOT use inputenc with XeLaTeX/LuaLaTeX
% \usepackage[utf8]{inputenc} % UTF-8 encoding (not needed with XeLaTeX)


\usepackage{verbatim} % Multi-line comments
\usepackage{graphicx} % For inserting images
\usepackage{float} % Image placement control
...
% Hyperlinks (load AFTER geometry, setspace, etc.)
\usepackage{hyperref}


% ============================================================================
% OPENDYSLEXIC FONTS SELECTION (loaded AFTER other packages)
% ============================================================================


% Use explicit paths to OTF files to avoid WOFF issues
...
% Preliminary header/footer configuration
\fancypagestyle{plain}{
    \fancyhf{} % Clear previous settings
    \fancyhead[RO,LE]{\fontsize{10}{12}\textit{\thepage}}
    \fancyhead[RE]{\fontsize{10}{12}\textit{Pentesting in virtualized environments with EVE-NG}}
    \fancyfoot{}
}
\pagestyle{plain}
...
*****************************************************************************
*                           IMPORTANT!!!                                    *
*   The following two commands (\newpage, \null) are used to create a blank *
*   page. This is necessary because when switching page numbering (from      *
*   Roman to Arabic), creating a new \chapter does not automatically detect *
*   whether the last page is even or odd. After the glossary finishes, you  *
*   should check if it ends on an even or odd page; if it ends on an odd    *
*   page, add a blank page manually to ensure chapters begin on the correct  *
*   side.
*****************************************************************************
\end{comment}
...
% Main header/footer configuration
\fancypagestyle{plain}{
    \fancyhf{} % Clear previous settings
    \fancyhead[RO,LE]{\fontsize{10}{12}\textit{\thepage}}
    \fancyhead[LO]{\fontsize{10}{12}\textit{\nouppercase{\textit{\leftmark}}}}
    \fancyhead[RE]{\fontsize{10}{12}\textit{Pentesting in virtualized environments with EVE-NG - TFG}}
    \fancyfoot{}
}
\pagestyle{plain}
