...
file (\texttt{.unl}), a student lab guide and an instructor resolution guide, an assessment rubric, and supporting
...
and is also published online at the \href{https://TheEgea.github.io/TFG/annexos/}{project online documentation}.
...
\begin{description}
    \item[Chapter~1 --- Introduction] Presents the educational gap motivating this project,
    the institutional and pedagogical context, the proposed solution, and an overview of
    the document structure.

    \item[Chapter~2 --- State of the Art] Reviews existing cybersecurity training platforms,
    virtualisation frameworks, and academic lab environments, positioning the project within
...
and supplementary documentation---are available in Volume~II (Annexos) and online at
the \href{https://TheEgea.github.io/TFG/annexos/}{project documentation site}.
