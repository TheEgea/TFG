...
\textbf{Deliverables}:
\begin{itemize}
\item Deployment scripts (Bash/Python) --- 3 per lab: deploy, reset, validate
...
\section{Internal Scope (Tecnocampus)}
