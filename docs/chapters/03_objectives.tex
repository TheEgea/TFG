...
\textbf{Description}: Validated that the package meets educational and technical requirements through a small pilot group representative of the target student population. The following targets were set and subsequently verified (see Section~\ref{sec:pilot_validation}):
...
\begin{itemize}
    ...
    \item Integration of real attack and defence techniques aligned with
          OWASP Top~10\cite{owasp2021}, NIST SP~800-61\cite{nist_sp80061}, and applied cryptography and steganography
