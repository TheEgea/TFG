...
This chapter outlines the comprehensive methodology employed in this TFG project, encompassing research strategy, development approach, validation methods, and project lifecycle management. The project integrates principles from software engineering, cybersecurity pedagogy, and empirical research to ensure systematic development and validation of the EVE-NG-based teaching package.
...
\item \textbf{TFG Report Writing and Finalization} (90h)
\begin{itemize}
\item TFG Report Writing Phase I (15h): Introduction, Object, Literature Review
\item TFG Report Writing Phase II (40h): Methodology, Requirements, Implementation Results
\item TFG Report Writing Phase III (35h): Validation, Analysis, Conclusions
...
\item Final TFG report (150-200 pages)
...
\item LaTeX for formal project documentation (this TFG report)
...
This comprehensive methodology ensures that the TFG project is executed systematically, with clear phases, measurable deliverables, and validation checkpoints. The combination of iterative development, user-centered design, and rigorous quality assurance will result in a robust, effective, and sustainable educational tool for cybersecurity training.