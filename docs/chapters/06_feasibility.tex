...
This phase established the technical infrastructure necessary for project development, including virtualization environment (EVE-NG)\cite{eve_ng}, development tools (VSCode, LaTeX)\cite{vscode,latex_project}, and pentesting platform (Parrot OS Security)\cite{parrot_os}.
