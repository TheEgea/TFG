...
The project has \textbf{13 critical tasks} (277 h total) that directly impact milestone deadlines:
...
amortised over 3--5 years; commercially comparable alternatives cost 800--1{,}500\,\euro/year.


\subsection{Temporal Feasibility}

The project timeline spans 10 months (July 2025--May 2026) distributed
across four phases totalling 820 hours (20 ECTS $\times$ 25~h/ECTS),
as shown in Table~\ref{tab:task_categories}. The critical path comprises
13 tasks (277~h) with deadlines monitored continuously
...
The project's energy footprint is dominated by the HomeLab server (150\,W avg.) and
...
emissions by 32\% relative to grid-only scenarios\cite{red_electrica,murugesan2008}.
...
open-source stack extends usable lifespan of existing hardware.
...
DVWA\cite{dvwa}) designed explicitly for training are used as targets. The project is
...
complementary online services --- were used strictly to review draft text, detect
...
\begin{itemize}
    \item \textbf{Prior knowledge}: Students with limited background in networking or
          operating systems may find early labs more demanding. Mitigated through
