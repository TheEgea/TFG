...
The complete project timeline was planned and visualized using a custom interactive web application developed specifically for this thesis. The tool is available in the project repository at \\ \texttt{docs/resources/gantt/index.html} and supports task management, critical path identification, progress tracking by phase, and PNG/CSV export. The exported Gantt chart image is stored at \texttt{docs/images/gantt\_planning.png} for reference.
...
\begin{itemize}
    ...
    \item \textbf{Proven Technology Stack}: The selected technologies (Proxmox~VE/EVE-NG for virtualization, Python/Bash for scripting, LaTeX for documentation) are industry-standard and have established best practices.\cite{murphy2018}
