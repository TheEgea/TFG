...
The project comprises \textbf{37 tasks} across seven categories, totalling 820 hours
(20 ECTS $\times$ 25 h/ECTS). The detailed phase breakdown and activity descriptions
are provided in Chapter~\ref{ch:methodology} (Methodology).
...
\midrule
    ...
    Network Equipment & 1 & 150\,\euro & 150\,\euro \\
...
module (\textasciitilde{}140\,\euro) was acquired during the project and is not reflected
...
\midrule
    Electricity consumption (820\,h $\times$ 0.215\,kWh $\times$ 0.20\,\euro/kWh) & 35\,\euro \\
...
\midrule
    ...
    Hardware         & 2{,}250\,\euro  \\
    Software         & 0\,\euro        \\
    Other (electricity, internet, contingency) & 1{,}142\,\euro \\
    \textbf{TOTAL}   & \textbf{15{,}692\,\euro} \\
\bottomrule
    \end{tabularx}
...
Phase~0 infrastructure was fully operational, with 100\% complete (EVE-NG, Proxmox\cite{proxmox}, Parrot OS\cite{parrot_os},
...
\midrule
    ...
    Pentesting             & Reconnaissance, exploitation, web vulns, applied cryptography and steganography & Intermediate \\
...
The project spanned ten months (July 2025--May 2026) across four phases totalling
...
workstation (65\,W avg.). Development phase consumption: 176.3\,kWh; operational phase
...
offsetting approximately 32\% of development-phase consumption and reducing CO\textsubscript{2}
...
Sustainability measures: VMs suspended when idle; fully digital documentation; modular server hardware designed for 3--5 year longevity;
...
modification, and redistribution. Per TecnoCampus ESUPT regulations~\cite{tecnocampus_normativa} (Article 10), intellectual property
...
The project follows TecnoCampus ESUPT bachelor's thesis regulations~\cite{tecnocampus_normativa} (approved
September 30, 2021): original work with IEEE citation standards (Article 11 on
plagiarism); structure aligned with the normative evaluation requirements (continuous
...
student population\cite{conti2019}.
...
\begin{itemize}
    ...
    \item \textbf{Reading difficulties (dyslexia)}: Dense technical documentation
          ...
          \href{https://opendyslexic.org}{OpenDyslexic}, an open-source typeface
          designed by Abelardo Gonz\'{a}lez. The weighted bottom of each letterform
          acts as a visual anchor, reducing character inversion and rotation errors
          common in dyslexic reading. For readers without dyslexia, the typeface
          presents no legibility penalty --- it is an example of universal design:
          a deliberate accessibility choice that benefits those who need it without
          inconveniencing anyone else. Lab documentation additionally uses short
          paragraphs, descriptive headings, and visually separated code blocks.
          The pilot study confirmed that a participant with documented dyslexia
          was able to complete Lab~3 with the materials provided.
\end{itemize}
\newpage
...
The project schedule was modelled using a custom interactive Gantt tool included in the repository at \path{docs/resources/gantt/index.html}. The resulting chart covers 37 tasks across Phases~0--4, of which thirteen lie on the critical path. It is reproduced as the Gantt chart in Appendix~I.
