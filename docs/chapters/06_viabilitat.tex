...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item CO\textsubscript{2} emissions (Spain avg. 0.25 kg CO\textsubscript{2}/kWh): 47.15 kg CO\textsubscript{2}
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item CO\textsubscript{2} emissions: 20.7 kg CO\textsubscript{2}/year
    \end{itemize}
\end{itemize}
...
\begin{table}[H]
    ...
    \hline
    \end{tabularx}
    \caption{CO\textsubscript{2} emissions comparison across different laboratory approaches}
\end{table}
