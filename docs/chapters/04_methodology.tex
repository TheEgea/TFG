...
\item Security tools installation (Kali Linux\cite{kali_linux}, Metasploit\cite{metasploit}, Burp Suite\cite{burp_suite})
...
\item Final bachelor's thesis report (70-120 pages)
...
\item Kali Linux penetration testing guide \cite{kali_linux}
