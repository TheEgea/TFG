...
\subsection{Problem Statement and Educational Gap}
...
(e.g., CEH, OSCP) expect hands-on experience in realistic environments, yet 
...
\begin{enumerate}
    ...
    \item \textbf{Web Application Vulnerabilities}: Practical exploitation 
          of OWASP Top 10 categories within controlled, intentionally 
...
\begin{itemize}
    ...
    \item Integration of real vulnerabilities and techniques aligned with 
          OWASP Top 10 and CIS Critical Controls
...
\subsection{Why EVE-NG? Selection Rationale}
...
\subsubsection{Key Advantages of EVE-NG}
...
\subsection{Alignment with Computer Engineering Degree}
