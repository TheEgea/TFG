...
to use proper service enumeration before any exploitation attempt. A quick teacher reference --- credentials, network table, and startup checklist --- is compiled
