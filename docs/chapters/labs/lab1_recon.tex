...
diagrams, node configuration, student guide, and instructor walkthrough are in Appendix~ef{app:lab1}; interactive documentation at \path{docs/web/docs/labs/lab1/}.
