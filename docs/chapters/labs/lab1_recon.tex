...
(\texttt{pebcak.local}) resolved through pfSense's Unbound resolver, forcing students
to use proper service enumeration before any exploitation attempt. Full topology
diagrams, node configuration, student guide, and instructor walkthrough are in the \href{https://TheEgea.github.io/TFG/annexos/app-b/}{project online documentation}; interactive documentation at \path{docs/web/docs/labs/lab1/}.
...
The solution adopted was to inject keystrokes directly via the QEMU monitor socket,
...
resolved by pfSense's Unbound resolver. The issue was that Unbound, by default,
...
On subsequent restarts, the Unbound configuration that had been applied via the
