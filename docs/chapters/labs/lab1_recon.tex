...
(\texttt{pebcak.local}) resolved through pfSense's Unbound resolver~\cite{unbound_dns}, requiring students
to use proper service enumeration before any exploitation attempt. Full topology
diagrams, node configuration, student guide, and teacher walkthrough are in the Appendix~B; interactive documentation at \path{docs/web/docs/labs/lab1/}.
