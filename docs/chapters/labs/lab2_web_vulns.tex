...
collect all three flags. Full topology, source code, credentials, and startup procedure are in Appendix~ef{app:lab2}; interactive documentation at \path{docs/web/docs/labs/lab2/}.
