...
and YAML deserialization --- to collect all three flags. A quick teacher reference --- credentials, startup procedure, and flag guide --- is compiled in Appendix~C;
...
\texttt{FLAG\{synapse\_pivot\_server\_b\}}    & \texttt{/admin} classified panel on Server-A & Broken auth + SQLi chain \\
