...
collect all three flags. Full topology, source code, credentials, and startup procedure are in the Appendix~C; interactive documentation at \path{docs/web/docs/labs/lab2/}.
