...
\section{Pilot Validation}\label{sec:pilot_validation}

A pilot study was carried out during April--May 2026 to evaluate
whether the labs met the design requirements and whether participants could
complete them using the provided guides.
...
All assigned lab sessions were completed (9 out of 9); no participant failed to finish the lab they were assigned to. No technical problem prevented completion. The average satisfaction score was \textbf{4.67 out
of 5}, which is above the 4/5 target set in O4 (Chapter~\ref{ch:objectives}). The average
...
average of 122 minutes, just over the target. This is consistent with the higher complexity of the lab, which includes
a forensic analysis task and a structured incident report --- activities
that require more time than purely technical exercises. Both differences are small and fit
...
\paragraph{Initial environment access.}
...
because the guide did not explain upfront that nginx~\cite{nginx} works as a reverse proxy
...
\paragraph{Conceptual context for procedural steps.}
...
all together present a high information density that can be challenging to parse. The guide assumed students
...
\paragraph{Narrative coherence across labs.}
...
but noted that the narrative connection between the labs could be made more explicit. Framing
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{X c c c}
    ...
    \bottomrule
  \end{tabularx}
  \caption{O4 KPI compliance after pilot study}
  \label{tab:kpi_compliance}
\end{table}

All four KPIs from O4 were met. The small differences in per-lab times are
