...
The pilot study design is described in Section~\ref{sec:pilot_design} (Chapter~\ref{ch:methodology}).
...
All assigned lab sessions were completed (nine out of nine); no participant failed to finish the lab they were assigned to. No technical problem prevented completion. The average satisfaction score was \textbf{4.67 out
