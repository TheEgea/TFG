...
\begin{itemize}
\item Student lab guide PDF (\textit{enunciado}) per lab --- task description, objectives,
      hints, and tools reference
\item Instructor resolution guide PDF (\textit{resolució}) per lab --- full walkthrough,
