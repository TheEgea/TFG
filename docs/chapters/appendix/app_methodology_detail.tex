...
\textbf{Deliverables}: Formal project proposal (Avantprojecte); detailed Gantt chart with
...
Student lab guide PDF (\textit{enunciado}) per lab: task description, objectives, hints,
and tool reference. Instructor resolution guide PDF (\textit{resolucio}) per lab:
...
\textbf{Deliverables}: 3 fully functional EVE-NG labs; student and instructor guides;
