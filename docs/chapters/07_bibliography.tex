...
% \nocite{*}  % Commented: bibliography now shows only cited entries (cleaner for academic submission)
...
This bibliography compiles all sources referenced throughout this Final Degree Project (Bachelor's thesis).
...
\begin{itemize}
\item Parrot OS Security and security tool collections
