...
\textbf{Success Criteria}: See technical KPIs in Chapter~4 (Table~\ref{tab:kpi_all}).
...
\textbf{Success Criteria}: 4 student guides (enunciado PDF) and 4 instructor guides
...
Detailed sub-requirements for RF1.2--RF1.4, RF2.5, RF3.3--RF3.4, TR1.2, TR1.4, TR2.4, TR3.3, and the full NFR subsections are provided in Appendix~\ref{app:requirements-detail}.
