...
\item \textbf{RF2.4}: Lab 4 --- Ransomware Response \textit{(planned)}: students
      take the role of a system administrator responding to an active ransomware incident.
      Two of three servers remain accessible; the third is locked by encryption. Tasks cover
      identifying the attack vector, recovering encrypted files using different decryption
      techniques, and restoring access. Flags are obtained by successfully decrypting files
      or recovering credentials.
\end{itemize}
...
Detailed sub-requirements for RF1.2--RF1.4, RF2.5, RF3.3--RF3.4, TR1.3, TR1.4, TR2.4, TR3.3, and the full NFR subsections are provided in the \href{https://theegea.github.io/TFG/annexos/app-h/}{project online documentation}.
