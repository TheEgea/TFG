...
\textbf{O1} is fully achieved: all four labs are implemented and functional. \textbf{O2} is fully achieved: automation scripts cover ISO upload,
bridge configuration, and connectivity checks, with at least one utility script
per lab as required. \textbf{O3} is fully achieved: all four labs have complete student and teacher guide pairs. \textbf{O4} is substantially complete: the pilot study (April--May~2026) confirmed usability and
