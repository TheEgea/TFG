...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{l X l}
    ...
    \midrule
    OE1 & Design and implement 4 EVE-NG labs     & Completed \\
    OE2 & Develop automation scripts              & Completed \\
    OE3 & Develop structured teaching materials   & Completed \\
    OE4 & Validate usability and effectiveness    & Completed (Labs~1--3; Lab~4 pending) \\
    \bottomrule
  \end{tabularx}
...
\textbf{OE1} is fully achieved: all four labs are implemented and functional. \textbf{OE2} is fully achieved: automation scripts cover ISO upload,
bridge configuration, and connectivity checks, with at least one utility script
per lab as required. \textbf{OE3} is fully achieved: all four labs have complete student and teacher guide pairs. \textbf{OE4} is substantially complete: the pilot study (April--May~2026) confirmed usability and
