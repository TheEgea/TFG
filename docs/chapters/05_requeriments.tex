...
\hline
\textbf{ID} & \textbf{Type} & \textbf{Requirement} & \textbf{Lab} \\
\hline
RF1.1 & Functional & Design 4 topologies & All \\
\hline
RF1.2 & Functional & 5-8 VMs per topology & All \\
\hline
RF2.1 & Functional & Lab 1 reconnaissance & Lab 1 \\
\hline
...
\hline
RF3.1 & Functional & Learning outcomes & All \\
\hline
RF3.2 & Functional & Assessment rubrics & All \\
\hline
TR1.1 & Technical & EVE-NG 5.0+ & Platform \\
\hline
TR1.3 & Technical & Host 64GB RAM, 2TB storage & Infrastructure \\
\hline
TR2.1 & Technical & Kali Linux 2024 & Tools \\
\hline
NFR1.1 & Non-Func & Deploy less/equal 2 min & Performance \\
\hline
NFR2.1 & Non-Func & NIST alignment & Compliance \\
\hline
NFR3.1 & Non-Func & MTBF greater/equal 100h & Reliability \\
\hline
